...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference('Parcel.count') do
      post parcels_url, params: { parcel: { capicity: @parcel.capicity, locker_box_id: @parcel.locker_box_id, name: @parcel.name, recipient_id: @parcel.recipient_id } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { capicity: @parcel.capicity, locker_box_id: @parcel.locker_box_id, name: @parcel.name, recipient_id: @parcel.recipient_id } }
