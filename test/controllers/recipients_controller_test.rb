...
class RecipientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post recipients_url, params: { recipient: { email: @recipient.email, full_name: @recipient.full_name, identification: @recipient.identification, phone_number: @recipient.phone_number } }
    end
  ...
  test "should update recipient" do
    patch recipient_url(@recipient), params: { recipient: { email: @recipient.email, full_name: @recipient.full_name, identification: @recipient.identification, phone_number: @recipient.phone_number } }
